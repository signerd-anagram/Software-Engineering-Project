...
/* CSS: /js/yui/container/assets/skins/sam/container.css */
/*
...
/* CSS: /js/yui/container/assets/skins/infusion/container.css */
/*
Copyright (c) 2008, Yahoo! Inc. All rights reserved.
Code licensed under the BSD License:
http://developer.yahoo.net/yui/license.txt
...
.yui-skin-sam .mask{background-color:#000;-ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=25)";filter: progid:DXImageTransform.Microsoft.Alpha(Opacity=25);opacity:.25;}
...
.yui-skin-sam .yui-panel .hd{padding:0 10px;font-size:93%;line-height:2;*line-height:1.9;font-weight:bold;color:#000;background:url(/js/yui/assets/skins/sam/sprite.png) repeat-x 0 -200px;}
.yui-skin-sam .yui-panel .hd{font-size: 20px;font-weight: normal;color: white;font-family: Arial,Verdana,Sans-Serif;background-color: #6095d7;background-image: none;background-repeat: repeat;background-attachment: scroll;background-position: 0% 0%;}
...
.yui-skin-sam .container-close{position:absolute;top:5px;right:6px;width:25px;height:15px;background:url(/js/yui/assets/skins/sam/sprite.png) no-repeat 0 -300px;cursor:pointer;}
...
.yui-skin-sam .yui-panel-container.shadow .underlay{position:absolute;top:2px;right:-3px;bottom:-3px;left:-3px;*top:3px;*left:-1px;*right:-1px;*bottom:-1px;_top:0;_right:0;_bottom:0;_left:0;_margin-top:3px;_margin-left:-1px;background-color:#000;b}
...
.yui-skin-sam .yui-simple-dialog .bd .yui-icon{background:url(/js/yui/assets/skins/sam/sprite.png) no-repeat 0 0;width:16px;height:16px;margin-right:10px;float:left;}
...
.yui-skin-sam .yui-tt-shadow-visible{-ms-filter: "progid:DXImageTransform.Microsoft.Alpha(Opacity=12)";filter: progid:DXImageTransform.Microsoft.Alpha(Opacity=12);opacity:.12;}
